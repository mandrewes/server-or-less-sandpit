...
public class SearchWithFreeFormFields extends AbstractLambdaSpringService<Stuff, ApiGatewayResponse> {

    private static final Logger LOG = Logger.getLogger(SearchWithFreeFormFields.class);

    @Autowired
    private StuffService stuffService;

    public SearchWithFreeFormFields() {
        super();
        wire(this);
    }
